        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmed = table.Column<BitArray>(type: "bit(1)", nullable: false),
                    ...
                    PhoneNumberConfirmed = table.Column<BitArray>(type: "bit(1)", nullable: false),
                    TwoFactorEnabled = table.Column<BitArray>(type: "bit(1)", nullable: false),
                    LockoutEnd = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    LockoutEnabled = table.Column<BitArray>(type: "bit(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("GlassType_pkey", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Use = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    Algorithm = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    IsX509Certificate = table.Column<BitArray>(type: "bit(1)", nullable: false),
                    DataProtected = table.Column<BitArray>(type: "bit(1)", nullable: false),
                    Data = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("Recipe_pkey", x => x.Id);
                    table.ForeignKey(
                        name: "glasstype_fk",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitOfMeasurement = table.Column<string>(type: "character varying", nullable: false),
                    Quantity = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("RecipeIngredient_pk", x => new { x.IngredientId, x.RecipeId });
                    table.ForeignKey(
                        name: "ingredient_fk",
